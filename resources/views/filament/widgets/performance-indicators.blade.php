<div class="bg-white rounded-lg p-6 shadow-sm border border-gray-200" style="grid-column: span 2;" x-data="{ activeTab: 'clients' }">
    ...
    <div x-show="activeTab === 'clients'" x-transition class="grid grid-cols-3 gap-6">
        <div class="p-4 rounded-lg bg-blue-50 border border-blue-100">
            ...
            <div class="text-3xl font-bold text-blue-900 mt-2">{{ $this->getTotalClients() }}</div>
        </div>
        <div class="p-4 rounded-lg bg-blue-50 border border-blue-100">
            <span class="text-xs font-medium text-blue-700">Clients Actifs</span>
            <div class="text-3xl font-bold text-blue-900 mt-2">{{ $this->getActiveClients() }}</div>
        </div>
        <div class="p-4 rounded-lg bg-blue-50 border border-blue-100">
            <span class="text-xs font-medium text-blue-700">Clients avec Tâches</span>
            <div class="text-3xl font-bold text-blue-900 mt-2">{{ $this->getClientsWithTasks() }}</div>
        </div>
    </div>
    ...
    <div x-show="activeTab === 'tasks'" x-transition class="grid grid-cols-3 gap-6">
        <div class="p-4 rounded-lg bg-purple-50 border border-purple-100">
            ...
            <div class="text-3xl font-bold text-purple-900 mt-2">{{ $this->getTotalTasks() }}</div>
        </div>
        <div class="p-4 rounded-lg bg-purple-50 border border-purple-100">
            <span class="text-xs font-medium text-purple-700">Tâches en cours</span>
            <div class="text-3xl font-bold text-purple-900 mt-2">{{ $this->getInProgressTasks() }}</div>
        </div>
        <div class="p-4 rounded-lg bg-purple-50 border border-purple-100">
            <span class="text-xs font-medium text-purple-700">Tâches terminées</span>
            <div class="text-3xl font-bold text-purple-900 mt-2">{{ $this->getCompletedTasks() }}</div>
        </div>
    </div>
    ...
    <div x-show="activeTab === 'contacts'" x-transition class="grid grid-cols-3 gap-6">
        <div class="p-4 rounded-lg bg-green-50 border border-green-100">
            ...
            <div class="text-3xl font-bold text-green-900 mt-2">{{ $this->getTotalContacts() }}</div>
        </div>
        <div class="p-4 rounded-lg bg-green-50 border border-green-100">
            <span class="text-xs font-medium text-green-700">Contacts par Client</span>
            <div class="text-3xl font-bold text-green-900 mt-2">{{ $this->getAverageContactsPerClient() }}</div>
        </div>
        <div class="p-4 rounded-lg bg-green-50 border border-green-100">
            <span class="text-xs font-medium text-green-700">Contacts Récents</span>
            <div class="text-3xl font-bold text-green-900 mt-2">{{ $this->getRecentContacts() }}</div>
        </div>
    </div>
    ...
    <div x-show="activeTab === 'activities'" x-transition class="grid grid-cols-3 gap-6">
        <div class="p-4 rounded-lg bg-orange-50 border border-orange-100">
            ...
            <div class="text-3xl font-bold text-orange-900 mt-2">{{ $this->getTotalActivities() }}</div>
        </div>
        <div class="p-4 rounded-lg bg-orange-50 border border-orange-100">
            <span class="text-xs font-medium text-orange-700">Activités (7j)</span>
            <div class="text-3xl font-bold text-orange-900 mt-2">{{ $this->getRecentActivitiesCount() }}</div>
        </div>
        <div class="p-4 rounded-lg bg-orange-50 border border-orange-100">
            <span class="text-xs font-medium text-orange-700">Activités Aujourd'hui</span>
            <div class="text-3xl font-bold text-orange-900 mt-2">{{ $this->getTodayActivities() }}</div>
        </div>
    </div>
</div>
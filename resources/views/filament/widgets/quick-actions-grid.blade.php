<div class="bg-white rounded-lg p-6 shadow-sm border border-gray-200" style="grid-column: 1 / -1;">
    ...
    <div class="space-y-0">
            <div class="grid grid-cols-6 gap-3">
                ...
                <a href="{{ route('filament.admin.resources.clients.create') }}" class="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-orange-50 hover:bg-orange-100 border border-orange-100 transition-colors">
                ...
                <a href="{{ route('filament.admin.resources.contacts.create') }}" class="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-blue-50 hover:bg-blue-100 border border-blue-100 transition-colors">
                ...
                <a href="{{ route('filament.admin.resources.tasks.create') }}" class="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-green-50 hover:bg-green-100 border border-green-100 transition-colors">
                ...
                <a href="{{ route('filament.admin.resources.activities.index') }}" class="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-purple-50 hover:bg-purple-100 border border-purple-100 transition-colors">
                ...
                <a href="{{ route('filament.admin.resources.clients.index') }}" class="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-teal-50 hover:bg-teal-100 border border-teal-100 transition-colors">
                ...
                <a href="{{ route('filament.admin.resources.tasks.index') }}" class="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-amber-50 hover:bg-amber-100 border border-amber-100 transition-colors">

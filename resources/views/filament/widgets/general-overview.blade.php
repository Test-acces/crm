<div class="bg-white rounded-lg p-6 shadow-sm border border-gray-100" style="grid-column: span 2;">
    ...
    <div class="grid grid-cols-4 gap-4">
        ...
        <div class="space-y-3">
            ...
            <div class="text-3xl font-bold text-gray-900">{{ $this->getTotalFleet() }}</div>
            ...
            <div class="h-16 relative">
                ...
                <svg class="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                    <path d="{{ $pathData }}" fill="none" stroke="rgb(147 197 253)" stroke-width="2" />
                    <path d="{{ $pathData }} L 100,100 L 0,100 Z" fill="rgb(191 219 254)" opacity="0.3" />
                </svg>
            </div>
        </div>
        ...
        <div class="space-y-3">
            ...
            <div class="text-3xl font-bold text-gray-900">{{ number_format($this->getTotalRevenue(), 0, ',', ' ') }}</div>
            ...
            <div class="h-16 relative">
                ...
                @endphp
                <svg class="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                    <path d="{{ $pathData }}" fill="none" stroke="rgb(192 132 252)" stroke-width="2" />
                    <path d="{{ $pathData }} L 100,100 L 0,100 Z" fill="rgb(216 180 254)" opacity="0.3" />
                </svg>
            </div>
        </div>
        ...
        <div class="space-y-3">
            ...
            <div class="text-3xl font-bold text-gray-900">{{ number_format($this->getRevenueToCollect(), 0, ',', ' ') }}</div>
            ...
            <div class="h-16 relative">
                ...
                @endphp
                <svg class="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                    <path d="{{ $pathData }}" fill="none" stroke="rgb(251 146 60)" stroke-width="2" />
                    <path d="{{ $pathData }} L 100,100 L 0,100 Z" fill="rgb(254 215 170)" opacity="0.3" />
                </svg>
            </div>
        </div>
        ...
        <div class="space-y-3">
            ...
            <div class="text-3xl font-bold text-gray-900">{{ $this->getOccupancyRate() }}%</div>
            ...
            <div class="h-16 relative">
                ...
                @endphp
                <svg class="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                    <path d="{{ $pathData }}" fill="none" stroke="rgb(74 222 128)" stroke-width="2" />
                    <path d="{{ $pathData }} L 100,100 L 0,100 Z" fill="rgb(187 247 208)" opacity="0.3" />
                </svg>
            </div>
        </div>
    </div>
